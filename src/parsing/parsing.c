...
// echo -n Hey mom !
	...
	// tk0->token_type = TK_CMD;
	// tk0->data.cmd.args = ft_calloc(sizeof(char *), 10);
	// tk0->data.cmd.args[0] = ft_strdup("echo");
	// tk0->data.cmd.args[1] = ft_strdup("-n");
	// tk0->data.cmd.args[2] = ft_strdup("");
	// tk0->data.cmd.args[3] = ft_strdup("Hey");
	// tk0->data.cmd.args[4] = ft_strdup("mom");
	// tk0->data.cmd.args[5] = ft_strdup("!");
	// tk0->data.cmd.paths = NULL;
	// tk0->parent = NULL;
	// tk0->left = NULL;
	// tk0->right = NULL;
	// tk0->data.cmd.is_last = true;
