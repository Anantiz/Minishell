...
/*   Updated: 2024/01/24 17:19:41 by aurban           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// echo "Hey mom! > Newfile.txt"
	...
	tk1->data.cmd.args[1] = ft_strdup("A");
	tk1->data.cmd.paths = NULL;
	tk1->parent = tk0;
	tk1->left = NULL;
	tk1->right = NULL;
	...
	tk3->data.cmd.args[0] = ft_strdup("echo");
	...
	tk5->data.cmd.args[0] = ft_strdup("echo");
	tk5->data.cmd.args[1] = ft_strdup("C");
	...
	tk6->data.cmd.args[0] = ft_strdup("echo");
	tk6->data.cmd.args[1] = ft_strdup("d");
